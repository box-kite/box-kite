...
export const propertyGroups: ParityGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      {
        tailwind: 'no utility — scroll-driven animation',
        props: [
          'animationTimeline',
          'animationRange',
          'animationRangeStart',
        ...
        status: 'has',
        note: 'no Tailwind utility: progress comes off a scroll position, so the animation costs no JS at all',
      },
      {
        tailwind: 'no utility — view transitions',
        props: ['viewTransitionName', 'viewTransitionClass'],
        status: 'has',
        note: 'no Tailwind utility; Box.viewTransition() is the ~40 lines around startViewTransition',
      },
      {
