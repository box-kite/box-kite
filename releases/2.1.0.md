...
_21 September 2026 · [npm](https://www.npmjs.com/package/@box-kite/react) · [Compare v2.0.1...v2.1.0](https://github.com/box-kite/box-kite/compare/v2.0.1...v2.1.0)_
...
Everything here is additive, so nothing you have written has to change. One thing to know before upgrading: a `theme` block now generates an `@scope` rule, which needs Chrome 118+, Safari 17.4+ or Firefox 128+ — [below that the theme is dropped silently](#theming-now-needs-a-2023-browser).
