...
_4 September 2026 · [npm](https://www.npmjs.com/package/@box-kite/react) · [Compare v3.3.3...v1.0.0](https://github.com/box-kite/box-kite/compare/v3.3.3...v1.0.0)_
...
For most projects the move is one find-and-replace, and `@cronocode/react-box@3.4.0` re-exports this package for anything not ready yet. If you are upgrading from 3.3.3 rather than only renaming, read [Breaking changes](#breaking-changes) first.
...
- **The palette values changed** to their OKLCH equivalents; no token name changed. Check brand colours against the swatches on [/colors](https://www.box-kite.dev/colors/).
